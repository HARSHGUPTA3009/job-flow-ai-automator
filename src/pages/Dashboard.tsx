...
const Dashboard = () => {
  ...
  const handleATSCheck = async () => {
    ...
    try {
      const res = await fetch("https://harshwillmakethis.app.n8n.cloud/webhook/atscheck", {
        method: "POST",
        body: formData,
      });
...
const handleColdEmailSetup = async () => {
  ...
  try {
    const res = await fetch("https://harshwillmakethis.app.n8n.cloud/webhook/coldemail", {
      method: "POST",
